...
const companySearchSchema = require("../schemas/companySearch.json"); //fixed schema name
...
router.get("/", async function (req, res, next) {
  try {
    ...
    // if (req.query.minEmployees || req.query.maxEmployees || req.query.name) {
    //   filter = req.query;
...
router.patch("/:handle", adminUser, async function (req, res, next) {
  try {
...
router.delete("/:handle", adminUser, async function (req, res, next) {
  try {
